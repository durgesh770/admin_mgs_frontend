...
import { useCreateExpense, useUpdateExpense } from "@/hooks/Accounts/Expense";
...
export const EditExpense = ({
  ...
  const createRevenue = useCreateExpense();
  const updateRevenue = useUpdateExpense();
  ...
  return (
    <>
      <SideDrawer
        ...
        onClose={() => {
          setDrawerOpenSecEdit(false), removeQuery(router, ["addExpense"]);
        }}
